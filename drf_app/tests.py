...
from drf_app.api import serializers
...
class StreamPlatformTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.stream = models.StreamPlatform.objects.create(name="Netflix",
                                about="#1 Streaming Platform", website="https://www..netflix.com")
...
class WatchListTestCase(APITestCase):
    ...
    def test_watchlist_create(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_405_METHOD_NOT_ALLOWED) # I have to work on it later
...
class ReviewTestCase(APITestCase):
    ...
    def test_review_user(self):
        response = self.client.get('/movie/user-reviews/?username=' + self.user.username)
        self.assertEqual(response.status_code, status.HTTP_200_OK)